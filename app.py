...
FROM_PASSWORD = "xcwbcedwgvohpnfv"  # Assurez-vous que ce mot de passe est correct (Gmail App Password recommandé)

# Initialisation de l'application Streamlit
st.title("Secret Santa des Blue Monthy")

# Afficher une image en arrière-plan
st.image(load_image("santa.jpg"), use_column_width=True)
